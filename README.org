...
* Tasks
** TODO Infix for org stuff (capture, agenda)
...
* Some helping stuff
  ...
  #+begin_src emacs-lisp
    (use-package which-key
      ...
      (which-key-mode))
  #+end_src
  Helpful is a better documentation for
  functions/commands/variables/keys
  #+begin_src emacs-lisp
    (use-package helpful
      :custom
...
* Ivy/counsel
  Ivy is vertical completion mechanism for emacs, a bit too much for
  my needs, I guess I'll be fine with selectrum, but whatever.
  #+begin_src emacs-lisp
    (use-package ivy
      :diminish
      :config
  ...
  command (like M-x, ibuffer, find-file)
  #+begin_src emacs-lisp
    (use-package counsel
